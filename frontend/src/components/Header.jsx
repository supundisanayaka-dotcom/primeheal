...
const Header = () => {
  ...
  return (
    <div className="relative w-full rounded-2xl overflow-hidden bg-slate-900 min-h-[420px] md:min-h-[460px] flex flex-col md:flex-row transition-all duration-300 shadow-lg">
      ...
      <div className="relative z-20 md:w-1/2 flex flex-col items-start justify-center gap-4 py-12 px-6 md:px-10 lg:px-20 m-auto md:py-[10vw] md:mb-[-30px]">
      ...
      <div className="hidden md:block md:w-1/2 relative z-20" />
